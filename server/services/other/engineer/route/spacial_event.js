...
router.get('/getSpacialEventByEngineerId', async (req, res)=>{
    try {
        ...
        INNER JOIN room AS r ON l.location_id = r.location_id
        WHERE tm.engineer_id = ${escape(req.query['engineer_id'])}
        `);
